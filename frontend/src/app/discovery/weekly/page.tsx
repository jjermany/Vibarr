...
import { Sparkles, ArrowLeft, Music, RefreshCw } from 'lucide-react'
...
export default function DiscoverWeeklyPage() {
  ...
  const section = sections.find((s: any) => s.id === 'discover_weekly')
    ...
    <div className="space-y-8">
      ...
      {!backendReady || isLoading ? (
        ...
        <EmptyState
          ...
          description="Start listening to music and syncing your library to get personalized Discover Weekly recommendations."
          action={
